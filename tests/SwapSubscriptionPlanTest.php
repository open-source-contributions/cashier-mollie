...
class SwapSubscriptionPlanTest extends BaseTestCase
{
    ...
    public function canSwapToAnotherPlan()
    {
        ...
        $this->assertSame('weekly-20-1', $subscription->plan);
        ...
        $this->assertSame('Twice as expensive monthly subscription', $new_order_item->description);
        ...
        $this->assertSame('Monthly payment', $credit_item->description);
        ...
        $this->assertSame('Twice as expensive monthly subscription', $processed_item->description);
        ...
        $this->assertSame('Twice as expensive monthly subscription', $scheduled_order_item->description);
    ...
    public function canSwapNextCycle()
    {
        ...
        $this->assertSame('weekly-20-1', $subscription->next_plan);
        ...
        $this->assertSame(2200, $new_order_item->total);
        $this->assertSame(200, $new_order_item->tax);
        $this->assertSame('Twice as expensive monthly subscription', $new_order_item->description);
    ...
    protected function getUserWithZeroBalance()
    {
        ...
        $this->assertSame(0, $user->credits()->whereCurrency('EUR')->count());
